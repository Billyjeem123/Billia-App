    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            <td class="content">
                ...
                <!-- Transaction Details -->
                <div style="background-color: #28a745; border-radius: 8px; padding: 20px; margin: 20px 0; border-left: 4px solid {{ strtolower($data->content->transactions->status ?? '') === 'failed' || strtolower($data->content->transactions->status ?? '') === 'reversed' ? '#555' : '#555' }};">
                    ...
                    <div style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin: 20px 0; border-left: 4px solid #555;">
                        <h3 style="margin-top: 0; color: #555; font-size: 18px;">💰 Payment Reversed</h3>
                    ...
                    <!-- Failure Message -->
                    <div style="background-color: #28a745; border-radius: 8px; padding: 20px; margin: 20px 0; border-left: 4px solid #555;">
