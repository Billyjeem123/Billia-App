...
class PaystackService
{
     ...
     */
    public function createCustomer(array $data, ?int $userId = null): JsonResponse|array
    {
        try {
     ...
     */
    public function initializeTransaction(array $data): JsonResponse|array
    {
        try {
     ...
     * Verify transaction
     */
    public function verifyTransaction(string $reference): JsonResponse|array
    {
        try {
     ...
     */
    private function handleApiError(Response $response, string $defaultMessage): JsonResponse|array
    {
     ...
     */
    private function handleInvalidResponse(array $responseData): JsonResponse|array
    {
     ...
     */
    private function handleException(\Exception $e): JsonResponse|array
    {
    ...
    public function createDedicatedAccount(string $customerCode, ?int $userId = null, array $options = []): JsonResponse
    {
        try {
            $payload = [
